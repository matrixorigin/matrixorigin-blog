---
title: Why is shuffle support needed?
author: Ni Tao
mail: nitao@matrixorigin.io
description: >-
  The basic principle of the shuffle algorithm is to bucket the input data,
  where each bucket's data can be processed independently and output results.
  This reduces the size of the hash table when aggregating data.
tags:
  - technology
keywords:
  - MatrixOne
  ...
  - shuffle
  - HTAP Database
publishTime: '2024-03-08 17:00:00+00:00'
image:
  '1': /content/en/why-is-shuffle-support-needed/why-is-shuffle-support-needed.jpg
  '235': /content/en/why-is-shuffle-support-needed/why-is-shuffle-support-needed.jpg
date: '2024-03-08 17:00:00+00:00'
lang: en
status: published
---
...
## Shuffle Implementation Principle
...
In the next article, we would explore Colocate shuffle.

We're really keen to hear your thoughts and answer any questions you might have.
