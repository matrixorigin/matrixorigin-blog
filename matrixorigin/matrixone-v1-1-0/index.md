---
title: 'Release Note: MatrixOne 1.1.0'
author: MatrixOrigin
mail: contact@matrixorigin.io
description: >-
  We are excited to announce MatrixOne 1.1.0 release! MatrixOne is a
  hyper-converged cloud-native database. It is designed to provide a
  cloud-native, high-performance, highly scalable, MySQL-compatible HTAP
  database. MatrixOne enables users to handle mixed workloads such as
  transactions, analytics, time-series, and streaming processing through a
...
_MatrixOne is a hyper-converged cloud-native database. It is designed to provide a cloud-native, high-performance, highly scalable, MySQL-compatible HTAP database. MatrixOne enables users to handle mixed workloads such as transactions, analytics, time-series, and streaming processing through a one-stop data processing solution._
...
- Starting from this iteration, modump is managed in a separate repo ([https://github.com/matrixorigin/mo_dump](https://github.com/matrixorigin/mo_dump)).
...
- Secondary Index doesnt apply for IN queries.

## New Contributors

- [@aronchanisme](https://github.com/aronchanisme) made their first contribution in [#11424](https://github.com/matrixorigin/matrixone/pull/11424)
- [@xmh1011](https://github.com/xmh1011) made their first contribution in [#12112](https://github.com/matrixorigin/matrixone/pull/12112)
- [@orangekame3](https://github.com/orangekame3) made their first contribution in [#12330](https://github.com/matrixorigin/matrixone/pull/12330)
- [@joker-star-l](https://github.com/joker-star-l) made their first contribution in [#11098](https://github.com/matrixorigin/matrixone/pull/11098)
- [@lcxznpy](https://github.com/lcxznpy) made their first contribution in [#13810](https://github.com/matrixorigin/matrixone/pull/13810)

Full Changelog: [v1.0.0…v1.1.0](https://github.com/matrixorigin/matrixone/compare/v1.0.0...v1.1.0)
