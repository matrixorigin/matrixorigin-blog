---
title: >-
  Building an Open-Source AI Native Software Platform Around Computational Power
  & Data by MatrixOrigin
author: MatrixOrigin
mail: lipengxiang@matrixorigin.cn
description: >-
  To address the challenges of the AI Big Model era, Matrix Origin has launched
  the MatrixOS product. MatrixOS consists of three core sub-products, which can
  either be combined into an all-in-one solution or independently deployed to
  provide services.
keywords:
  - MatrixOne
  - MatrixDC
