---
title: 技术解读|MatrixOne高效 CDC：基于快照的分布式数据库优化方案
author: MatrixOrigin
description: MatrixOne 引入基于快照的 CDC 方法，提升数据变更捕获效率，本文探讨其核心优势、技术原理及实际应用场景
tags:
  - 技术干货
keywords:
  - MatrixOne
...
![1.png](/content/zh/mo-cdc-v2/1.png)  
**图1：MatrixOne CDC整体流程**，展示快照式捕获与传统方法的对比。

![2.png](/content/zh/mo-cdc-v2/2.png)  
**图2：表数据与墓碑数据结构**，展示 `MatrixOne` 中数据存储的逻辑视图。

![3.png](/content/zh/mo-cdc-v2/3.png)  
...
![4.png](/content/zh/mo-cdc-v2/4.png)  
